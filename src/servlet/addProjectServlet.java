...
public class addProjectServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		projectServer pro=new projectServer();  //(int zyId,String bjName)
//		System.out.println(jo.toString());
		String rs1=pro.addProject(jo.get("prName").toString().substring(1,jo.get("prName").toString().length()-1),jo.get("prInfo").toString().substring(1,jo.get("prInfo").toString().length()-1));
