...
/**
 * Servlet implementation class addXyServlet
 */
@WebServlet("/addXyServlet")
public class addXyServlet extends HttpServlet {
...
//		System.out.println("--addXy"+json.toString());
		...
		xyServer xy=new xyServer();
		String rs1=xy.addXy(jo.get("xyName").toString().substring(1,jo.get("xyName").toString().length()-1),jo.get("xyInfo").toString().substring(1,jo.get("xyInfo").toString().length()-1));
