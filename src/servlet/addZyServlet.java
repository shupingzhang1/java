...
/**
 * Servlet implementation class addZyServlet
 */
@WebServlet("/addZyServlet")
public class addZyServlet extends HttpServlet {
...
//		System.out.print(jo.get("xyId").toString());
		zyServer xy=new zyServer();
		
		String rs1=xy.addZy(Integer.parseInt(jo.get("xyId").toString().substring(1,jo.get("xyId").toString().length()-1)),jo.get("zyName").toString().substring(1,jo.get("zyName").toString().length()-1),jo.get("zyInfo").toString().substring(1,jo.get("zyInfo").toString().length()-1));
