...
/**
 * Servlet implementation class addSemesterServlet
 */
...
public class addSemesterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		semesterServer semester=new semesterServer();  //(int zyId,String bjName)
//		System.out.println(jo.toString());
		String rs1=semester.addSemester(jo.get("semesterName").toString().substring(1,jo.get("semesterName").toString().length()-1));
