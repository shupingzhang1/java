...
/**
 * Servlet implementation class deleteExamTypeServlet
 */
@WebServlet("/deleteExamTypeServlet")
public class deleteExamTypeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deleteExamTypeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String rs1=examType.deleteExamType(Integer.parseInt(jo.get("examTypeId").toString().substring(1,jo.get("examTypeId").toString().length()-1)));
