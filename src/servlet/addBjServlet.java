...
/**
 * Servlet implementation class addBjServlet
 */
@WebServlet("/addBjServlet")
public class addBjServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		bjServer bj=new bjServer();  //(int zyId,String bjName)
//		System.out.println(jo.toString());
		String rs1=bj.addBj(Integer.parseInt(jo.get("zyId").toString().substring(1,jo.get("zyId").toString().length()-1)),jo.get("bjName").toString().substring(1,jo.get("bjName").toString().length()-1));
